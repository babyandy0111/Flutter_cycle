...
import '../qtcomm_widget_utils.dart';
import 'package:flutter/material.dart';
import 'package:flutter/widgets.dart';

class QTContainerWidgetParser extends WidgetParser {
  @override
  ...
  @override
  String get widgetName => "QTContainer";
  ...
  Map<String, dynamic> export(Widget widget, BuildContext buildContext) {
    ...
    return <String, dynamic>{
      ...
      // "decoration": BoxDecoration(color: realWidget.color),
    };
  }
