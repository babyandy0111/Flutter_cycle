...
import 'package:flutter_cycle/qtcomm_utils/qtcomm_utils.dart';
  ...
  _getMoreData() async {
    if (!isPerformingRequest) {
      ...
      var buildWidgets = DynamicWidgetBuilder.buildWidgets(
          jsonDecode(jsonString), widget._buildContext, new DefaultClickListener(widget._buildContext));
      setState(() {
...
[
  ...
  doRequest() async {
    ...
    try {
      var response = await http.get(Uri.parse(postLoadMoreUrl(
